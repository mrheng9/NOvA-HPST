...
class HeterogenousSegmentPointSetTransformer(nn.Module):
    def __init__(
        self,
        in_channels,
        num_classes,
        ...
        super(HeterogenousSegmentPointSetTransformer, self).__init__()
...
class HeterogenousPointSetTransformerInterface(nn.Module):
    def __init__(self, options: Options, feature_dim: int, output_dim: int):
        super().__init__()
        self.network = HeterogenousSegmentPointSetTransformer(
            feature_dim,
            output_dim,
