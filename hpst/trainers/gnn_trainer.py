"""
EdgeGNN based model as per https://arxiv.org/pdf/2003.11603
"""
...
from hpst.models.gnn import GNNInterface
...
class GNNTrainer(NeutrinoBase):
    def __init__(self, options: Options, train_perc=None):
        ...
        """
        super(GNNTrainer, self).__init__(options, train_perc=train_perc)

        self.num_objects = 10
        self.num_classes = self.training_dataset.num_classes
        self.network = GNNInterface(options,
