...
from hpst.models.heterogenous_point_set_transformer import HeterogenousPointSetTransformerInterface
...
class HeterogenousPointSetTrainer(NeutrinoBase):
    def __init__(self, options: Options, train_perc=0.5, num_objects=10):
        ...
        """
        super(HeterogenousPointSetTrainer, self).__init__(options, train_perc=train_perc)

        self.num_objects = num_objects
        self.num_classes = self.training_dataset.num_classes
        self.network = HeterogenousPointSetTransformerInterface(options,
                                                            self.training_dataset.num_features + 2,
