...
from hpst.trainers.point_set_sim_trainer import PointSetSimTrainer
...
NETWORK = PointSetSimTrainer

#TESTING_FILE = "/baldig/physicsprojects/roblesee/preprocessed_nova_miniprod6_1_cvnlabmaps.h5"
BASE_DIRECTORY =  "./results/pst/lightning_logs/version_15"
CHECKPOINT_PATH = "./results/pst/lightning_logs/version_15/checkpoints/last.ckpt"
...
save_dir = Path("fil-result/pst_sim")
