...
def main(
    ...
    from hpst.trainers.pointnet_trainer import PointNetTrainer
    Network = PointNetTrainer
    ...
    if debug:
        ...
        logger = TensorBoardLogger(save_dir="results/pointnet", name=name, log_graph=graph)
