...
BASE_DIRECTORY =  "./results/mask_rcnn/lightning_logs/version_260"
CHECKPOINT_PATH = "./results/mask_rcnn/lightning_logs/version_260/checkpoints/last.ckpt"
...
save_dir = Path("fil-result/rcnn_sim")
