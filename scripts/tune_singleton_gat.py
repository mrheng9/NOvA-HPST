...
def main(config):
    ...
    options.update_options({
        ...
        "gnn_neighbors": config["gnn_neighbors"],
        "gnn_layers": config["gnn_layers"],
        "epochs": options.epochs // options.learning_rate_cycles,
...
if __name__ == '__main__':
    ...
    search_space = {
        ...
        "gnn_layers": tune.choice([4,8,16]),
        "learning_rate": tune.loguniform(1e-4, 1e-1),
        "gnn_hidden_channels": tune.choice([64,128,256]),
        "gnn_neighbors": tune.choice([8,16])
    }
