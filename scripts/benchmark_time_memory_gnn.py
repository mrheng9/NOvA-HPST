...
from hpst.trainers.gnn_trainer import GNNTrainer 
...
BASE_DIRECTORY =  "./gnn/lightning_logs/version_28"
CHECKPOINT_PATH = "./gnn/lightning_logs/version_28/checkpoints/last.ckpt"
