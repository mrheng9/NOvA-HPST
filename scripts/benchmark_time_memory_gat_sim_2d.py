...
from hpst.trainers.gat_sim_trainer import GATSimTrainer
...
NETWORK = GATSimTrainer

#TESTING_FILE = "/baldig/physicsprojects/roblesee/preprocessed_nova_miniprod6_1_cvnlabmaps.h5"
BASE_DIRECTORY =  "./gat/lightning_logs/version_5"
CHECKPOINT_PATH = "./gat/lightning_logs/version_5/checkpoints/last.ckpt"
...
save_dir = Path("fil-result/gat_sim")
