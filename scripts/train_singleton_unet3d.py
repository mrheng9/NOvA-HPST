...
def main(
    ...
    from hpst.trainers.unet_3d_sim_trainer import Unet3dSimTrainer
    Network = Unet3dSimTrainer
    ...
    if debug:
        ...
        logger = TensorBoardLogger(save_dir="results/unet", name=name, log_graph=graph)
