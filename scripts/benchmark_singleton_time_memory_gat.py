...
from hpst.trainers.singleton_gat_trainer import GATTrainer
...
BASE_DIRECTORY =  "./results/gat/lightning_logs/version_32"
CHECKPOINT_PATH = "./results/gat/lightning_logs/version_32/checkpoints/last.ckpt"
