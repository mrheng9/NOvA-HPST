...
BASE_DIRECTORY =  "/home/dikshans/hpst" #irrelevant
OPTIONS_PATH = "/home/dikshans/hpst/config/gnn/gat_tune_nova.json"
CHECKPOINT_PATH = "/home/dikshans/hpst/HPST/j9zyjz20/checkpoints/last.ckpt"

# Load checkpoint and add the test file location
options = Options.load(f"{OPTIONS_PATH}")
if TESTING_FILE:
